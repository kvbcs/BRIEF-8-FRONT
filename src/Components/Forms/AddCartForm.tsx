...
// }) => {
// 	const [quantity, setquantity] = useState<AllCartProps>();
// 	// const {
// 	// 	register,
// 	// 	handleSubmit,
// 	// 	watch,
// 	// 	formState: { errors },
// 	// } = useForm<AllCartProps>();

// 	// const onSubmit: SubmitHandler<AllCartProps> = (data, productId) =>
// 	function handleSubmit() {
// 		let data = {
// 			quantity: quantity,
// 		};
// 		addCartProduct(data, product.id)
// 			.then((res) => {
// 				console.log(res);
