...
const page = () => {
	...
	return (
		<main className="min-h-screen max-h-fit mt-10 mb-40 w-full flex flex-col justify-evenly">
			...
			<section className="flex flex-col gap-4 md:flex-row md:justify-evenly md:min-h-[500px] md:max-h-fit">
